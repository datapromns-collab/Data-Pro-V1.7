    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] p-4">
      <Card className="w-full max-w-[400px] p-8 shadow-2xl border-slate-200 rounded-3xl bg-white/80 backdrop-blur-xl">
        <div className="flex flex-col items-center text-center mb-8">
          <div className="bg-white p-3 rounded-2xl shadow-xl border border-slate-100 mb-4 w-20 h-20 flex items-center justify-center">
            <Image src="/logo.svg" alt="Data Pro" width={64} height={64} className="object-contain" />
          </div>
