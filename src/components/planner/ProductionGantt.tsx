      ...
      <div className="flex flex-col gap-1 min-w-[850px] print:min-w-0">
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        (isSpecial || isMaterialTest || isOther) ? "z-[11]" : ""
                      )}
                      style={style}
                    >
                        ...
                        {shifts?.dayLabel && (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1.5 whitespace-nowrap overflow-hidden justify-center">
                              ...
                              {!isSpecial && !isMaterialTest && !isOther && (
                        ...
                        {shifts?.nightLabel && (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1.5 whitespace-nowrap overflow-hidden justify-center">
                              ...
                              {!isSpecial && !isMaterialTest && !isOther && (
                                <span className="font-bold text-slate-800 text-[11px] conical shrink-0">
        ...
        <div className="mt-4 flex items-center justify-between border-t-2 border-slate-100 pt-3 print:pt-2">
          ...
          <div className="flex items-center gap-6 print:gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className="w-5 h-2 rounded-sm" style={{ backgroundColor: OTHER_TASK_COLOR }}></div>
              <span className="text-[9px] font-bold text-slate-400 uppercase">OTROS</span>
            </div>
            <div className="flex items-center gap-2">
