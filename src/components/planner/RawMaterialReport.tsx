          ...
          <table className="w-full border-collapse text-[7pt]">
            <thead>
              <tr className="bg-[#4a7ebb] text-white font-black uppercase h-7">
                <th style={{ width: '5cm' }} className="px-2 py-0 border border-slate-900 text-left">MATERIAL</th>
              ...
              {ALL_MATERIALS.map((mat, idx) => {
                ...
                return (
                  <tr key={mat.code} className={`h-5 font-bold ${idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'}`}>
                    <td style={{ width: '5cm' }} className="px-2 py-0 border border-slate-300 uppercase truncate leading-none">{mat.description}</td>
          ...
          <table className="w-full border-collapse text-[7.5pt] h-full">
            <thead>
              <tr className="bg-[#10b981] text-white font-black uppercase h-7">
                <th style={{ width: '5cm' }} className="px-2 py-0 border border-slate-900 text-left">PRODUCTO (SABOR)</th>
              ...
              {PRODUCT_LIST.map((flavor, idx) => {
                ...
                return (
                  <tr key={flavor} className={`h-5 font-bold ${idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'}`}>
                    <td style={{ width: '5cm' }} className="px-2 py-0 border border-slate-300 uppercase leading-none">{flavor}</td>
            ...
            <tfoot className="bg-emerald-100 text-slate-900 font-black">
              <tr className="h-7">
                <td style={{ width: '5cm' }} className="px-2 py-0 border border-slate-900 uppercase">TOTALES DIARIOS</td>
                {dateKeys.map((key, i) => {
