...
const DEFAULT_PERMISSIONS: UserPermissions = {
  ...
  'maria.mds': ['jarabes', 'raw-materials', 'planta', 'planta-admin', 'planning', 'management', 'ordenes-sap', 'procesos'],
  'alex.mds': ['jarabes', 'raw-materials', 'planta', 'planta-admin', 'planning', 'management', 'procesos'],
