...
const VALID_USERS = [
  ...
  { id: 'prodtj.mds', password: 'ad.144.', name: 'Jefes de Producción', role: 'STANDARD' as UserRole },
   { id: 'prodtg.mds', password: 'ad.521.', name: 'Carlos Barovich', role: 'STANDARD' as UserRole },
  { id: 'prodts.mds', password: 'ad.222.', name: 'Supervisor de Produccion', role: 'STANDARD' as UserRole },
   { id: 'procj.mds', password: 'ad.145.', name: 'Abel Araujo', role: 'STANDARD' as UserRole },
  { id: 'cald.mds', password: 'ad.146.', name: 'Jefa de Calidad', role: 'STANDARD' as UserRole },
  { id: 'prodt.mds', password: 'ad.160.', name: 'Ronald Valera', role: 'STANDARD' as UserRole },
  { id: 'prodt1.mds', password: 'ad.121.', name: 'Luis Blandin', role: 'STANDARD' as UserRole },
  { id: 'prodt2.mds', password: 'ad.128.', name: 'Luis Sanchez', role: 'STANDARD' as UserRole },
   { id: 'proc.mds', password: 'ad.166.', name: 'Tecnico de procesos', role: 'STANDARD' as UserRole },
    { id: 'proc1.mds', password: 'ad.533.', name: 'tecnico de procesos', role: 'STANDARD' as UserRole },
    { id: 'proc2.mds', password: 'ad.530.', name: 'tecnico de procesos', role: 'STANDARD' as UserRole },
  ...
  { id: 'MDS', password: 'MDS1', name: 'Multinacional de sabores', role: 'STANDARD' as UserRole },
];
